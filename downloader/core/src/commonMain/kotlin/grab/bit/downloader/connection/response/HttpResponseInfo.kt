package grab.bit.downloader.connection.response

import grab.bit.downloader.connection.IResponseInfo
import grab.bit.downloader.connection.response.headers.getContentRange
import grab.bit.downloader.connection.response.headers.extractFileNameFromContentDisposition
import grab.bit.downloader.exception.UnSuccessfulResponseException
import grab.bit.downloader.utils.FileNameUtil
import grab.bit.downloader.utils.throwIf
