...
import grab.bit.downloader.destination.DownloadDestination
import grab.bit.downloader.destination.SimpleDownloadDestination
...
import grab.bit.downloader.exception.DownloadValidationException
...
import grab.bit.downloader.part.*
import grab.bit.downloader.utils.*
import grab.bit.downloader.utils.speedlimiter.SpeedLimiter
import grab.bit.util.tryLocked
...
//            thisLogger().info("file prepared")
    ...
    fun getRequestedPartitionCount(): Int {
        ...
        val clamped = resolvePartCount(requested, downloadManager.settings.defaultThreadCount)
        return SequentialSchedule.effectivePartitionCount(clamped, sequentialMode)
    }
