...
data class AppSettingsModel(
    ...
    override val maxConnectionsPerHost: Int,
    override val interDownloadDelayMs: Int,
    override val minSplitSizeKb: Int,
    override val httpTimeoutSeconds: Int,
    ...
    override val copyFinishedTo: String,
...
private val AndroidSettingsSchema = S.typeSafeObject(
    ...
    factory = {
        PlatformAppSettingsModel(
            ...
            maxConnectionsPerHost = it[AppSettingsModel::maxConnectionsPerHost],
            interDownloadDelayMs = it[AppSettingsModel::interDownloadDelayMs],
            minSplitSizeKb = it[AppSettingsModel::minSplitSizeKb],
            httpTimeoutSeconds = it[AppSettingsModel::httpTimeoutSeconds],
            ...
            copyFinishedTo = it[AppSettingsModel::copyFinishedTo],
            ...
            webhookUrl = it[AppSettingsModel::webhookUrl],
